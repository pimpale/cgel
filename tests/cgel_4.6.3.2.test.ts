/**
 * Test file for CGEL 4.6.3.2: Constructions containing verb + intransitive preposition idioms
 * 
 ...
 * 
 * Also includes tests from 4.6.3.1 on fossilisation:
...
describe('CGEL 4.6.3.2 Structure I: verb – prep (intransitive)', () => {
...
describe('CGEL 4.6.3.2 Structure II: verb – prep – O', () => {
...
describe('CGEL 4.6.3.2 Structure III: verb – O^i – prep – O^d (ditransitive with particle)', () => {
...
describe('CGEL 4.6.3.2 Structure IV: verb – prep – transitive PP', () => {
...
describe('CGEL 4.6.3.2 Structure V: verb – O – prep – transitive PP', () => {
...
describe('CGEL 4.6.3.2 Structure VI: verb – prep – (as) PC', () => {
...
describe('CGEL 4.6.3.2 Structure VII: verb – O – prep – [as + PC]', () => {
...
// =============================================================================
// CGEL 4.6.3.1: Fossilisation Effects
// =============================================================================

describe('CGEL 4.6.3.1 Fossilisation: Preposing (Locative Inversion)', () => {
...
describe('CGEL 4.6.3.1 Fossilisation: Adjunct Insertion', () => {
...
describe('CGEL 4.6.3.1 Fossilisation: Order Alternation', () => {
...
describe('CGEL 4.6.3.1 Aspectual Particles', () => {
...
describe('CGEL 4.6.3.1 Polysemous Combinations (take in)', () => {
